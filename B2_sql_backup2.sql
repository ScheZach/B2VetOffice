...
--
-- Host: localhost:3306
-- Generation Time: Oct 29, 2018 at 10:30 AM
...
CREATE TABLE `animals` (
  ...
  `yearBorn` varchar(30) DEFAULT NULL,
...
INSERT INTO `animals` (`IDanimal`, `species`, `name`, `gender`, `yearBorn`, `entrant`, `IDcustomer`) VALUES
...
(33, 'Parrot', 'Jeff', 'M', '2018', 'BrockD', 33),
...
INSERT INTO `customers` (`IDcustomer`, `fname`, `mname`, `lname`, `address`, `city`, `state`, `zip`, `phone`, `entrant`) VALUES
...
(16, '2018-10-22', 'Rabies, needs to be put down', 'AlyseC', 16),
(17, '2018-09-18', 'Has a cut leg, needs to be cleaned and wrapped up', 'AlyseC', 17),
(18, '2018-08-07', 'Has a fever, prescribe antibiotics', 'AlyseC', 18),
(19, '2018-07-25', 'Hurt paw, schedule surgery', 'AlyseC', 19),
(20, '2018-09-09', 'Has diabetes, needs an insulin shot', 'AlyseC', 20),
(21, '2018-06-21', 'Broken leg, schedule immediate surgery', 'AlyseC', 21),
(22, '2018-05-10', 'Cut leg, wrap it in gauze', 'AlyseC', 22),
(23, '2018-02-01', 'Possible ear infection, check their ears', 'AlyseC', 23),
(24, '2018-01-14', 'Both ears are infected, prescribe ear drops', 'AlyseC', 24),
(25, '2018-05-20', 'Has fleas, prescribe flea medicine', 'AlyseC', 25),
(26, '2018-02-25', 'Possible fleas, prescribe a flea collar', 'AlyseC', 26),
(27, '2018-09-05', 'Has an ear infection, prescribe antibiotics', 'AlyseC', 27),
(28, '2018-10-18', 'Overweight, needs to be put on a diet', 'AlyseC', 28),
(29, '2018-03-17', 'Checkup went well, no treatment is needed ', 'AlyseC', 29),
(30, '2018-04-15', 'Eye infection, prescribe eye drops', 'AlyseC', 30),
(31, '2017-11-23', 'broken leg, needs a cast', 'Brielle L', 182),
(32, '2017-01-23', 'broken leg, needs surgery', 'Brielle L', 183),
(33, '2017-02-23', 'cracked beak, possible recunstruction', 'Brielle L', 184),
(34, '2017-03-23', 'lung failure, tests need to be done', 'Brielle L', 185),
(35, '2017-04-23', 'heart murmur, tests need to be done', 'Brielle L', 186),
(36, '2017-05-23', 'blind, needs help with adapting', 'Brielle L', 187),
(37, '2017-06-23', 'fin ripped off, just needs wrapped', 'Brielle L', 188),
(38, '2017-07-23', 'wing broken, needs wrapped', 'Brielle L', 189),
(39, '2017-08-23', 'having trouble hearing, needs help with adapting', 'Brielle L', 190),
(40, '2017-09-23', 'shell is cracked, needs repairing', 'Brielle L', 191),
(41, '2017-10-23', 'sore throat, prescribe medication', 'Brielle L', 192),
(42, '2017-12-23', 'possible skin condition, prescribe a form of oinment', 'Brielle L', 193),
(43, '2017-11-24', 'having constant diarrhea, prescribe medication', 'Brielle L', 194),
(44, '2017-11-25', 'ate too much chocolate, prescribe medication', 'Brielle L', 195),
(45, '2017-11-26', 'not having enough food, set a diet', 'Brielle L', 196),
(46, '2018-05-11', 'Hit By car (Needs surgery)', 'BrockD', 31),
(47, '2018-02-12', 'Attacked by bear (Needs surgery)', 'BrockD', 32),
(48, '2018-03-15', 'Broken wing (Stitches in Wing)', 'BrockD', 33),
(49, '2018-06-18', 'Neutured (Needs to be neutured)', 'BrockD', 34),
(50, '2018-11-30', 'Broken leg (Needs crutches)', 'BrockD', 35),
(51, '2018-08-01', 'Limp (Needs crutches)', 'BrockD', 36),
(52, '2018-07-21', 'Spade (Needs to be spaded)', 'BrockD', 37),
(53, '2018-03-23', 'Sick (Needs bedrest)', 'BrockD', 38),
(54, '2018-03-02', 'Deathly sick (Needs lots of bedrest)', 'BrockD', 39),
(55, '2018-04-15', 'Cant smell (Needs surgery)', 'BrockD', 40),
(56, '2018-01-05', 'Got stepped on (Needs body cast)', 'BrockD', 33),
(57, '2018-12-18', 'Snapped fang (Needs fang removed)', 'BrockD', 36),
(58, '2018-08-27', 'Limp (Needs cast)', 'BrockD', 32),
(59, '2018-09-20', 'Remove poison sack (Needs surgery)', 'BrockD', 32),
(60, '2018-04-09', 'Broken fin (Needs surgery)', 'BrockD', 38),
(61, '2018-03-17', 'Healthy.', 'Clayton W', 62),
(62, '2018-05-13', 'Healthy, neutered on 2018-05-19.', 'Clayton W', 63),
(63, '2018-03-16', 'Yeast infection, given new anti-biotic prescription.', 'Clayton W', 64),
(64, '2018-09-15', 'Ringworm, given new anti-biotic prescription.', 'Clayton W', 65),
(65, '2018-10-19', 'Broken right hind leg, requires surgery to put it back in place and a cast, scheduled for 2018-10-31.', 'Clayton W', 66),
(66, '2018-09-30', 'Left front leg broken, surgery already complete, in recovery.', 'Clayton W', 67),
(67, '2018-07-17', 'Healthy.', 'Clayton W', 68),
(68, '2018-08-09', 'Healthy, needs neutered, to be scheduled.', 'Clayton W', 69),
(69, '2018-10-26', 'Inflamed throat, given prescription pills to help.', 'Clayton W', 70),
(70, '2018-08-23', 'Healthy.', 'Clayton W', 71),
(71, '2018-10-27', 'Limping, scheduled second appointment on 2018-10-31.', 'Clayton W', 72),
(72, '2018-10-21', 'Healthy, needs spayed, to be scheduled.', 'Clayton W', 73),
(73, '2018-08-23', 'Lossing eyesight, no treatment available.', 'Clayton W', 74),
(74, '2018-08-23', 'Broken both hind legs, surgery already complete, in recovery.', 'Clayton W', 75),
(75, '2018-09-23', 'Multiple scratches, given new anti-biotic prescription to avoid infection.', 'Clayton W', 76),
(76, '2017-06-22', 'Broken Collar bone from unknown accident, surgury scheduled and cone required, checkup in 2 weeks', 'ethana', 77),
(77, '2016-12-07', 'Healthy, prescribed Vaccinations', 'ethana', 78),
(78, '2018-04-02', 'Foot Infection from camping trip, bandage required and medicine prescribed', 'ethana', 79),
(79, '2015-01-27', 'Scratch on top of head from unknown accident, bandage required', 'ethana', 80),
(80, '2018-08-16', 'Internal Fungus from being fed moss, medicine prescribed, checkup in 1 month', 'ethana', 81),
(81, '2014-04-13', 'Concussion from a fall, bandage required', 'ethana', 82),
(82, '2014-09-12', 'Dislocated front-left shoulder while running, cast and cone required, checkup in 2 months', 'ethana', 83),
(83, '2010-02-24', 'Eye stigmatism found, otherwise healthy', 'ethana', 84),
(84, '2015-03-02', 'Failing to feed itself; family decided to put it down', 'ethana', 85),
(85, '2017-09-10', 'Healthy, prescribed Vaccinations', 'ethana', 86),
(86, '2011-04-26', 'Large wound from wire fence, deceased due to blood loss from open wound', 'ethana', 87),
(87, '2017-11-15', 'Healthy, scheduled to be Neutered', 'ethana', 88),
(88, '2013-10-12', 'Broken Femer bone from falling off a tree, surgery scheduled and cone required', 'ethana', 89),
(89, '2018-03-21', 'Soap Poisoning, expected death 10 days', 'ethana', 90),
(90, '2018-03-21', 'Soap Poisoning, expected death 10 days', 'ethana', 91),
(91, '2017-10-20', 'Deworming, gave deworming pills', 'HunterF', 70),
(92, '2017-09-12', 'Vaccines, gave yearly shots', 'HunterF', 71),
(93, '2017-06-20', 'Broken Wing, surgery and cast with a checkup', 'HunterF', 72),
(94, '2017-10-23', 'Cut by fence, surgery and painkillers prescribed', 'HunterF', 73),
(95, '2018-10-23', 'Ate AntiFreeze, Deceased over night', 'HunterF', 74),
(96, '2017-11-15', 'Check up, gave tetnis shot', 'HunterF', 75),
(97, '2017-04-22', 'Dueclaw removal surgery', 'HunterF', 76),
(98, '2017-02-13', 'Dueclaw removal surgery', 'HunterF', 77),
(99, '2016-01-23', 'Not eating, Change of Diet', 'HunterF', 78),
(100, '2017-03-15', 'Broken Leg, surgery and cast with a checkup', 'HunterF', 79),
(101, '2017-12-11', 'Check up, healthy checkup no shots needed', 'HunterF', 74),
(102, '2017-08-18', 'Check up on Broken Wing, keep cast on come in for another checkup', 'HunterF', 72),
(103, '2017-06-16', 'Deworming, gave deworming pills', 'HunterF', 77),
(104, '2017-05-15', 'Check up on Broken leg, no cast needed and come back in for another checkup', 'HunterF', 79),
(105, '2017-09-25', 'Deworming, gave deworming pills', 'HunterF', 71),
(106, '2018-10-19', 'Rabies; needs to be put down', 'John H', 108),
(107, '2018-10-20', 'Stomach Cancer; needs to be put down', 'John H', 112),
(108, '2018-10-19', 'Needs cast to fit left leg whuich is broken.', 'John H', 121),
(109, '2018-10-22', 'Vaccinations for rabies needed', 'John H', 115),
(110, '2018-10-21', 'Lung Cancer; needs to be put down', 'John H', 115),
(111, '2018-10-18', 'Rabies; needs to be put down', 'John H', 117),
(112, '2018-10-17', 'Anchor Worms; needs pills', 'John H', 118),
(113, '2018-10-16', 'Broken left Leg; needs cast to fix', 'John H', 119),
(114, '2018-10-17', 'Brain Cancer; needs to be put down', 'John H', 116),
(115, '2018-10-22', 'Rare hair disease; needs to be put down', 'John H', 111),
(116, '2018-10-22', 'Hit by a car; needs to be put down', 'John H', 110),
(117, '2018-10-22', 'Twitches randomly; needs pills', 'John H', 121),
(118, '2018-10-22', 'Ringworm; Pills Needed', 'John H', 120),
(119, '2018-10-22', 'Stomach ulcers; needs pills', 'John H', 114),
(120, '2018-10-22', 'Will not eat; needs liquid food.', 'John H', 113),
(121, '2018-06-22', 'Healthy, No abnormalities. Schedule follow-up appointment.', 'Joseph M', 122),
(122, '2017-08-12', 'Very Healthy. Needs to schedule shell cleaning.', 'Joseph M', 123),
(123, '2018-01-01', 'Very healthy for it\'s age. Gave it a haircut.', 'Joseph M', 124),
(124, '2014-07-23', 'Gaining too much weight.Needs to go on a diet.', 'Joseph M', 125),
(125, '2018-09-17', 'All healthy, growing quickly. Schedule a follow-up appointment', 'Joseph M', 126),
(126, '2016-04-12', 'Having trouble with depression. Will prescribe anti-depressants', 'Joseph M', 127),
(127, '2017-11-17', 'Front left leg has simple fracture. Give cast and schedule follow-up appointment.', 'Joseph M', 128),
(128, '2018-08-13', 'Having episodes of PTSD. Prescribe medicinal marijuana.', 'Joseph M', 129),
(129, '2006-01-23', 'Very healthy and strong. Schedule follow-up appointment', 'Joseph M', 130),
(130, '2014-12-25', 'Low blood pressure. Schedule physical therapy.', 'Joseph M', 132),
(131, '2000-01-01', 'Growing old and having trouble with digestion. Prescribe pain meds and ant-acids', 'Joseph M', 131),
(132, '2015-06-25', 'Turned one year old. Schedule vaccinations.', 'Joseph M', 133),
(133, '2008-10-31', 'Diagnosed with paranoia. Schedule therapy sessions', 'Joseph M', 134),
(134, '2018-02-14', 'Healthy. Schedule follow-up appointment.', 'Joseph M', 135),
(135, '2017-05-27', 'Lethargic and unresponsive. Needs specialized diagnosis.', 'Joseph M', 136),
(136, '2016-12-28', 'Vaccines', 'JoshS', 137),
(137, '2017-02-10', 'Check up', 'JoshS', 138),
(138, '2017-02-13', 'Sprained Ankle Ice Pack applied', 'JoshS', 139),
(139, '2017-04-23', 'Medication', 'JoshS', 141),
(140, '2017-01-13', 'Check up', 'JoshS', 144),
(141, '2017-03-23', 'Diet Change', 'JoshS', 145),
(142, '2017-03-15', 'X-ray and cast broken leg', 'JoshS', 146),
(143, '2017-02-11', 'Deworming', 'JoshS', 147),
(144, '2017-11-03', 'Medication', 'JoshS', 147),
(145, '2017-11-12', 'Vaccines', 'JoshS', 148),
(146, '2018-01-23', 'Check up', 'JoshS', 150),
(147, '2018-02-15', 'Deworming', 'JoshS', 142),
(148, '2018-03-25', 'Check up on Broken leg', 'JoshS', 146),
(149, '2018-04-22', 'Check Up', 'JoshS', 143),
(150, '2018-07-23', 'Deceased', 'JoshS', 140),
(151, '2018-10-19', 'Rabies, Treatment: Shots', 'Justin F', 152),
(152, '2018-10-20', 'Fungus, Treatment: Salt Baths', 'Justin F', 154),
(153, '2018-10-19', 'Broken Leg, Treatment: Cast', 'Justin F', 153),
(154, '2018-10-22', 'Check-Up, Treatment: Vaccination', 'Justin F', 155),
(155, '2018-10-21', 'Trouble Eating, Treatment: New Diet Plan', 'Justin F', 156),
(156, '2018-10-18', 'Rabies, Treatment: Shots', 'Justin F', 157),
(157, '2018-10-17', 'Anchor Worms, Treatment: Potassium Permanganate', 'Justin F', 158),
(158, '2018-10-16', 'Broken Leg, Treatment: Cast', 'Justin F', 159),
(159, '2018-10-17', 'Overgrown Teeth, Treatment: Tooth Trims', 'Justin F', 160),
(160, '2018-10-22', 'Appetite Problems, Treatment: Testing Variety of Foods', 'Justin F', 161),
(161, '2018-10-22', 'West Nile Virus, Treatment: Vaccination and Future Care', 'Justin F', 162),
(162, '2018-10-22', 'Body Flukes, Treatment: Sterazin', 'Justin F', 163),
(163, '2018-10-22', 'Ringworm, Treatment: Anti-fungal Drugs', 'Justin F', 164),
(164, '2018-10-22', 'Hairballs, Treatment: Fluid Therapy', 'Justin F', 165),
(165, '2018-10-22', 'Clamped Fin, Treatment: Tetra Fungus Guard', 'Justin F', 166),
(166, '2018-06-20', 'Broken Leg. Given splint for 2 weeks', 'MichaelC', 168),
(167, '2016-02-04', 'Constipation. Given laxitaves to be given every time constipation occurs', 'MichaelC', 170),
(168, '2017-04-23', 'Tummy Troubles. Changed diet because of lactose intolerance.', 'MichaelC', 172),
(169, '2018-04-20', 'Leg Surgury. Follow up is necessary', 'MichaelC', 178),
(170, '2017-04-20', 'Ear Surgury. Need checkup but everything was looking okay', 'MichaelC', 179),
(171, '2016-04-20', 'Leg Surgury. Need physical therapy because of loss of motion', 'MichaelC', 180),
(172, '2015-05-15', 'Sprained Knee. Boot to keep knee from moving, will remove in 20 days', 'MichaelC', 169),
(173, '2015-12-24', 'Checkup. Everything looks great', 'MichaelC', 181),
(174, '2018-11-10', 'Vaccines. Rabies, Tetnis', 'MichaelC', 176),
(175, '2017-03-20', 'Worms. Vaccinated', 'MichaelC', 167),
(176, '2018-07-21', 'Worms. Vaccinated', 'MichaelC', 173),
(177, '2018-09-30', 'Problems Breathing. Gave asthma medicine to owner for daily use', 'MichaelC', 175),
(178, '2017-02-27', 'Laryngitis. Muzzle to rest voice ', 'MichaelC', 171),
(179, '2011-03-22', 'Flu. Administered flu shot', 'MichaelC', 174),
(180, '2001-02-12', 'Cut Leg. Cleaned and wrapped with gauze', 'MichaelC', 177),
(181, '2018-10-17', 'In good Health', 'Perry K', 182),
(182, '2018-10-17', 'Sickly and runs funny. Check Ligament', 'Perry K', 183),
(183, '2018-10-03', 'Healthy with a Damaged Wing that needs to be realigned', 'Perry K', 184),
(184, '2015-09-23', 'Health but Need Neutering', 'Perry K', 185),
(185, '2018-10-01', 'Healthy but Needs Trimming', 'Perry K', 186),
(186, '2018-10-11', 'Healthy and now Needs Vaccines', 'Perry K', 187),
(187, '2016-05-23', 'Questioning Life, Forgets Instructions every three seconds.', 'Perry K', 188),
(188, '2013-02-11', 'Has trouble breathing out of water.', 'Perry K', 189),
(189, '2015-06-14', 'Has a minor cold. No need for attention.', 'Perry K', 190),
(190, '2009-02-10', 'Gender Identity Problems, can\'t speak so I can\'t ask for clarification.', 'Perry K', 191),
(191, '2010-03-12', 'Shattered Beak, missing pieces, needs ducktape.', 'Perry K', 192),
(192, '2000-01-23', 'Transforms on full moon to warecow. Need anti-moon pills.', 'Perry K', 193),
(193, '2007-12-27', 'Running Funny needs ligament correction.', 'Perry K', 194),
(194, '2018-10-17', 'To small to see problems. Seems probably healthy. Bites Hurt', 'Perry K', 195),
(195, '2018-10-02', 'Forgets questions every three seconds. Transfer to brain doctor for better diagnosis', 'Perry K', 196),
(196, '2016-08-21', 'Got ran over by a car and broke his back left leg. He will need surgery and 3 checkup appointments', 'TannerH', 182),
(197, '2015-08-24', 'Ran into a pole and cracked his skull. He will need surgery to stabilise his skull', 'TannerH', 183),
(198, '1988-06-23', 'Got shot by a hunter and broke his wing. He will need to be put down', 'TannerH', 184),
(199, '2016-08-15', 'Ran into the street and got hit by a car. He broke his toe and will need to be put down', 'TannerH', 185),
(200, '2018-06-02', 'Cut himself on some wire. He will need some pills to keep it from being infected', 'TannerH', 186),
(201, '2017-05-23', 'Ate too much grass and got sick. He will need some laxitives to help him get it back out', 'TannerH', 187),
(202, '2018-01-01', 'Got half eaten by a bear and will need to be put down', 'TannerH', 188),
(203, '2015-06-28', 'Broke his leg and will need a cast to stabilise it.', 'TannerH', 189),
(204, '2001-03-09', 'Ate some bleech and will need some laxitives to get it out of his system.', 'TannerH', 190),
(205, '2016-02-01', 'Got a little overweight and will need to be put on a diet.', 'TannerH', 191),
(206, '2018-02-02', 'Fell off a rock and cracked his shell. His shell will need to be glued back together.', 'TannerH', 192),
(207, '2015-05-05', 'Got hit by a 4-Wheeler and broke his front left leg. His leg will need to be amputated.', 'TannerH', 193),
(208, '2015-04-04', 'Ate too much food and needs to be put on a diet.', 'TannerH', 194),
(209, '2018-06-06', 'Got worms and will need to be worked and some bedrest.', 'TannerH', 195),
(210, '2016-05-05', 'Got hit by a boat and will need to be put down.', 'TannerH', 196),
(211, '2018-09-24', 'year one rabies shot: requires a new vaccination for rabies', 'zacharys', 197),
(212, '2018-07-14', 'lack of vitamin A: prescribe a vitamin A supplement', 'zacharys', 198),
(213, '2018-04-16', 'dislocated knee: need to schedule surgery for the left hind leg', 'zacharys', 199),
(214, '2018-10-02', 'prescribe antibotics for ear infection', 'zacharys', 200),
(215, '2018-10-15', 'lack of calcium: prescribe a calcium supplement', 'zacharys', 201),
(216, '2018-10-18', 'safty precaution: vemon gland removal', 'zacharys', 202),
(217, '2018-05-19', 'safty precaution: defanging', 'zacharys', 203),
(218, '2018-07-23', 'prescribe antibotics for infection in a cut', 'zacharys', 204),
(219, '2018-05-04', 'cramp treatment for front legs', 'zacharys', 205),
(220, '2018-09-13', 'prescribe antibotics for ear infection', 'zacharys', 206),
(221, '2017-12-21', 'safty precaution: defanging', 'zacharys', 207),
(222, '2018-06-30', 'overgrown claws: claw trimming', 'zacharys', 208),
(223, '2018-07-12', 'prescribe antibotics for infection in a cut', 'zacharys', 209),
(224, '2018-04-12', 'lack of vitamin B12: prescribe a vitamin B12 supplement', 'zacharys', 210),
(225, '2018-04-28', 'broken left hind bone: need to schedule a surgery', 'zacharys', 211);
...
ALTER TABLE `diagnosis`
  ...
  ADD KEY `fk_diagnosis_animals1_idx` (`IDanimal`);
...
--
ALTER TABLE `diagnosis`
  MODIFY `IDdiagnosis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=226;
--
...
--
ALTER TABLE `animals`
  ADD CONSTRAINT `animals_ibfk_1` FOREIGN KEY (`IDcustomer`) REFERENCES `customers` (`IDcustomer`);

--
-- Constraints for table `diagnosis`
--
ALTER TABLE `diagnosis`
  ADD CONSTRAINT `fk_diagnosis_animals1` FOREIGN KEY (`IDanimal`) REFERENCES `animals` (`IDanimal`) ON DELETE NO ACTION ON UPDATE NO ACTION;
